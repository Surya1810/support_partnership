            ...
            <form id="formEditRAB" action="#" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="debitAmountEdit" class="col-sm-4 col-form-label">Debet Awal</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-sm price" id="debitAmountEdit"
                                    name="debit_amount" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
