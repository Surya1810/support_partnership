            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb text-black-50">
                        ...
                        <li class="breadcrumb-item active"><strong>Partner</strong></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card card-outline rounded-partner card-primary">
                        ...
                        <div class="card-body table-responsive">
                            <table id="partnerTable" class="table table-bordered text-nowrap text-center">
                                ...
                                <tbody>
                                    @foreach ($partners as $partner)
                                        <tr>
                                            ...
                                            @php
                                                $keyword = explode(',', $partner->keyword);
                                            @endphp
                                            <td>
