            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb text-black-50">
                        ...
                        <li class="breadcrumb-item active"><strong>Technology</strong></li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="card card-outline rounded-partner card-indigo">
                        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('debt.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="modal-body">
                        <input type="text" name="department" hidden value="5">
                        <div class="row">
                            <div class="col-12 col-md-6">
